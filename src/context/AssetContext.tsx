...
function toAssetRecord(data: MockData, asset: Asset, getUserById: (userId: string | null) => User | null): AssetRecord {
  ...
  return {
    ...
    expectedPrice: readLegacyExpectedPrice(asset),
    actualPrice: asset.actualPrice ?? readLegacyPurchasePrice(asset),
    requestId: readLegacyRequestId(asset),
